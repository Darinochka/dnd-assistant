...
**D&D Assistant** — это Telegram-бот, созданный, чтобы облегчить ведение и участие в сессиях Dungeons & Dragons 5e. Вместо "болтовни" от LLM, бот использует **точные workflow-механизмы** и **RAG (Retrieval-Augmented Generation)**, чтобы давать ответы, строго основанные на правилах, лоре кампании и текущем контексте игры.
